...
},{"./map":2,"immutable":3}],2:[function(require,module,exports){
const Immutable = require('immutable');
...
module.exports = () => {
	...
	let libro = Immutable.fromJS({
		...
		tiendas: [{ id_tienda: 'amazon', precio: 4000 }, { id_tienda: 'M++', precio: 323 }, { id_tienda: 'biblio', precio: 600 }, { id_tienda: 'bookStore', precio: 40.1 }]
	});
